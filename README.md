...
This repository contains the files used either in the process of searching pollinators, or the groups of pollinators themselves. To generate a set of all likely pollinating species, the below datasets needs to be merged with the Catalogue of Life (COL) tp pull across all the species names.
